  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Consulta métricas del taller en lenguaje natural.</p>
      </div>
      ...
      <Card className="flex flex-col">
        <CardHeader className="flex-row items-center justify-between py-4 px-6">
          <div>
            ...
            <CardDescription>{messages.length - 1} consulta{messages.length - 1 !== 1 ? "s" : ""} en esta sesión</CardDescription>
          </div>
