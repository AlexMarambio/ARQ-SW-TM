...
export default function OrdenesPage() {
  ...
  async function agregarRepuesto(e: FormEvent) {
    ...
    setMessage(null);
    try {
      await ordenesApi.addRepuesto(
        selected,
        Number(repuestoForm.id_repuesto),
        Number(repuestoForm.amount),
      );
      ...
      setError(
        err instanceof Error ? err.message : "No se pudo asignar el repuesto.",
      );
    } finally {
      setLoading(false);
    }
  ...
  async function cerrarOrden() {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "No se pudo cerrar la orden.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Crea, administra y cierra órdenes del taller.
          </p>
        </div>
              ...
              <form className="space-y-3" onSubmit={createOrden}>
                ...
                <Field label="Descripción del problema">
                  <Textarea
                    ...
                    onChange={(e) =>
                      setNewOrden({ ...newOrden, descripcion: e.target.value })
                    }
                    required
                  />
                </Field>
              ...
              <div className="border-t border-slate-100 pt-4">
                <Button
                  ...
                  disabled={
                    !selected ||
                    loading ||
                    selectedOrden?.estado === "entregado"
                  }
                >
